...
----------
GENERAL
- Change - To close the Changelog you now need to press BRAKE & THROTTLE together 50%, or click the button on the bottom
  Should prevent Changelog closing itself from Input flicker
- Change - Switching Layouts using the Hotkeys, SHIFT + LEFT/RIGHT ARROW will now be silent
